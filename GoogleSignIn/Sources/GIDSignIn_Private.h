...
/// Represents a completion block that takes a `GIDVerifiedAccountDetailResult` on success or
/// an error if the operation was unsuccessful.
typedef void (^GIDVerifyCompletion)(GIDVerifiedAccountDetailResult *_Nullable verifyResult,
                                    NSError *_Nullable error);
